...
if [[ "${GPU_SAFE_MODE}" == "true" ]]; then
  ...
  export LOCAL_LLM_CONTEXT_WINDOW="${LOCAL_LLM_CONTEXT_WINDOW:-176000}"
  export LOCAL_LLM_MAX_PROMPT_TOKENS="${LOCAL_LLM_MAX_PROMPT_TOKENS:-160000}"
  export LOCAL_LLM_MAX_OUTPUT_TOKENS="${LOCAL_LLM_MAX_OUTPUT_TOKENS:-20000}"
  export LOCAL_LLM_MAX_TOOL_CALL_TOKENS="${LOCAL_LLM_MAX_TOOL_CALL_TOKENS:-20000}"
fi
